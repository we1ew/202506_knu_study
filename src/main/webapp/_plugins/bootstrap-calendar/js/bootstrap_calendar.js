    ...
    $.fn.calendar = function(options) {
        ...
        this.each(function(){
            ...
            function showCalendar(){
                ...
                var btnNextMonth = $('<td><i class="icon-arrow-right" id="icon-arrow-right"></i></td>');
                ...
                var btnPrevMonth = $('<td><i class="icon-arrow-left" id="icon-arrow-left"></i></td>');
            ...
            function showDaysOfMonth(month, year){
                ...
                lblTextMonth.text(year + "." + months[month]);
